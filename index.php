...
echo '<td><a href="edit.php"><button type="submit" class="btn btn-success">Editer</button></a>
<a href="delete.php"><button type="submit" class="btn btn-success">Supprimer</button></a>';
echo '</td>';
echo '</tr>';
   }
